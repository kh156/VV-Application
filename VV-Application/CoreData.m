...
- (id)init {
    if (self = [super init]) {
        ...
        // sample code for insert/query data
/*
        Entity *entity = (Entity *)[NSEntityDescription insertNewObjectForEntityForName:@"Entity"
                                                                 inManagedObjectContext:self.managedObjectContext];
        [entity setName:@"Michael"];
        [entity setNumber:[NSNumber numberWithInt:7]];
        
        
        NSFetchRequest *request = [[NSFetchRequest alloc] init];
        NSEntityDescription *des = [NSEntityDescription entityForName:@"Entity"
                                               inManagedObjectContext:self.managedObjectContext];
        [request setEntity:des];
        NSPredicate *query = [NSPredicate predicateWithFormat:@"name == %@", @"Michael"];
        ...
        if (fetchResults == nil) {
            ...
            NSLog(@"%@", ((Entity *)[fetchResults objectAtIndex:0]).number);
        }
 */
